...
import org.vmasc.hla.gui.OutputPanel;
...
public class Trial
{
	...
	private List<Process> processList = new ArrayList<Process>();						//the list of prcoesses created for this test 
	...
	{
		return "java -jar imis-hla.jar " + trialId + " " + clientId + " " + numUpdates + " " + updateSize + " " + reportInterval + " " + numSubscriptions;
	}
