...
public class Constants
{
	...
	public static final String PROP_STR_FEDERATION_TYPE = "FEDERATION_TYPE";
	public static final String PROP_STR_FEDERATION_NAME = "FEDERATION_NAME";
	public static final String PROP_STR_FDD_FILE_NAME = "FDD_FILE_NAME";
}
